...
const listaDeNumeros = [1, 2, 3, 4, 5];let soma = 0;
...
Algorítimo: "A partir da idade do usuário vamos informar a sua situação em relação ao direito de voto eleitoral"
...
Classe retangulo herda FormaGeometrica{
    Atributos{
        ...
        Metodo Constructor(cor, base,largura){
            Super(cor){
  ...
  Classe Circulo herda Classe FormaGeometrica{
    Atributo{
        - raio
    }
...
```
```
Funcao Corrida(aceleracao, distancia, tempoMaximo, velocidadeInicial, velocidadeMaxima):
